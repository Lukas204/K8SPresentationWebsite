...
const LiteratureSection = () => (
  <section id="literature" className="summary-section">
    ...
    <div className="literature-grid">
      ...
      <a href="https://dpunkt.de/produkt/kubernetes-3/" className="card" target="_blank" rel="noopener noreferrer">
        <div className="card-img">
      ...
      <a href="https://opensource.com/sites/default/files/gated-content/osdc_cheatsheet-kubernetes-2021.4.16.pdf" className="card" target="_blank" rel="noopener noreferrer">
        <div className="card-img">
      ...
      <a href="https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Grundschutz/IT-GS-Kompendium_Einzel_PDFs_2022/06_APP_Anwendungen/APP_4_4_Kubernetes_Edition_2022.pdf?__blob=publicationFile&v=3" className="card" target="_blank" rel="noopener noreferrer">
        <div className="card-img">
